...
contract NFTDAO is Ownable, AutomationCompatibleInterface {
    ...
    function createProposal(
        ...
        require(!developmentContract.isThereDevelopmentContract(landNFTId), "Contract already exists");
        ...
        address stakingAddress = IStakingFactory(address(stakingFactory)).getStakingContractForNFT(landNFTId);
        NFTStaking presentStakingContract = NFTStaking(stakingAddress);
        require(presentStakingContract.totalStaked() >= presentStakingContract.targetAmount(), "LandNFT not fully staked");
     ...
     */
    function executeProposal(uint256 landNFTId) public {
        ...
        address stakingAddress = IStakingFactory(address(stakingFactory)).getStakingContractForNFT(landNFTId);
        NFTStaking presentStakingContract = NFTStaking(stakingAddress);
        presentStakingContract.recordDevelopmentContractMint();
